...
network_map = {
    ...
    'RDN_16': RDN(scale_factor=4, num_channels=3, num_features=16,
                 growth_rate=16, num_blocks=16, num_layers=8),
    'RDN_8': RDN(scale_factor=4, num_channels=3, num_features=8,
                 growth_rate=8, num_blocks=16, num_layers=8),
    ...
    'PRDN_22': RDN(scale_factor=4, num_channels=3, num_features=22,
                   growth_rate=22, num_blocks=16, num_layers=8),
    ...
    'RRDB_12': RRDBNet(3, 3, 12, 23, gc=6),
