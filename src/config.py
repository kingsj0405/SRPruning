...
class TrainingConfig(Config):
    def __init__(self):
        ...
        self.cfg.EXP.description = "Fine tuning, 0.8"
        # Save Settings
        ...
        self.cfg.TRAIN.load_checkpoint_path = f"{self.cfg.EXP.path}/checkpoint/v0/PrunedCARN_12.pth"
        self.cfg.TRAIN.network = 'PrunedCARN'
