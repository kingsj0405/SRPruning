...
writer = SummaryWriter('../../REWIND-vdsr/summary/v1/')

for epoch in range(1, 51):
    model = torch.load(f'../../REWIND-vdsr/checkpoint/v1/model_epoch_{epoch}.pth', map_location=lambda storage, loc: storage)["model"]
    for scale in scales:
